...
namespace ByteBank.SistemaAgencia
{
    ...
    public class ListaDeContaCorrente
    {
        ...
        public void AdicionarVarios(params ContaCorrente[] itens)//Com o PARAMS é possível chamar o método utilizando um ou vários argumentos, não sendo necessário
        ...
        public ContaCorrente this[int indice]//Indexador, acesso por meio de índices
        {
            get
            {
